...
from metagen.core.commands import (
    generate_command, import_command, list_command, validate_command,
    security_command, performance_command, health_command
)
...
def examples():
    ...
    examples_data = [
        ...
        ("Show security status", "metawalletgen security"),
        ("Show performance metrics", "metawalletgen performance"),
        ("Run health check", "metawalletgen health"),
...
def performance(ctx):
    ...
    verbose = ctx.obj.get("verbose", False)
    performance_command(ctx, verbose)
